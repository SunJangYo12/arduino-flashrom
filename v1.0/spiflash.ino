// ini untuk melihat isi chip rom dan menulis hex manual
// alternatif bisa menggunakan flashrom(frser-duino) dan ambil isi rom
// lalu edit menggunakan tools ghex
